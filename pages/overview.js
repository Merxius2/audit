      ...
      <div className="max-w-7xl mx-auto space-y-6 px-4 py-8 md:px-8">
        ...
        <div className="card p-6 border-brand-primary/20 bg-brand-primary/5">
          <p className="text-sm text-gray-700">
            <span className="font-semibold">💡 Tip:</span> This overview shows a summary of your financial data from all pages. Visit the Huishoudboekje page to enter detailed income and expenses, or check Retirement to plan your financial future.
          </p>
        </div>
      </div>
    </div>
