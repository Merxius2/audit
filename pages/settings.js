...
import { Settings as SettingsIcon, Trash2, Globe, DollarSign, Moon, Sun, Receipt, Download, Upload, Copy, Check } from 'lucide-react';
import { deleteCookie, loadFromCookie, saveToCookie } from '../lib/cookieStorage';
...
export default function SettingsPage() {
  ...
  const handleExport = () => {
    try {
      ...
      const exportStr = generateExportString(dashboardData, retirementData);
          ...
          <div className="space-y-3">
            ...
            {importMessage && (
              <div className={`mt-4 rounded-lg p-4 ${
                importMessage.includes('error') || importMessage.includes('failed') || importMessage.includes('Checksum') || importMessage.includes('Invalid') 
