              ...
              <table className="w-full text-xs md:text-sm">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    <th className="text-left px-1 sm:px-2 md:px-4 py-1 md:py-2 font-medium text-gray-700 dark:text-gray-300">{t('tax.range')}</th>
                    <th className="text-right px-1 sm:px-2 md:px-4 py-1 md:py-2 font-medium text-gray-700 dark:text-gray-300">{t('tax.rate')}</th>
                    <th className="text-right px-1 sm:px-2 md:px-4 py-1 md:py-2 font-medium text-gray-700 dark:text-gray-300">{t('tax.incomeInBracket')}</th>
                    <th className="text-right px-1 sm:px-2 md:px-4 py-1 md:py-2 font-medium text-gray-700 dark:text-gray-300">{t('tax.taxAmount')}</th>
                  </tr>
                </thead>
                <tbody>
                  {result.bracketsBreakdown.map((bracket, idx) => (
                    <tr key={idx} className="border-b border-gray-100 dark:border-gray-700">
                      <td className="px-1 sm:px-2 md:px-4 py-1 md:py-2 text-gray-900 dark:text-gray-100 text-xs md:text-sm">
                        {getSymbol()}
                      ...
                      <td className="text-right px-1 sm:px-2 md:px-4 py-1 md:py-2 text-gray-900 dark:text-gray-100 text-xs">{bracket.label}<br /><span className="text-gray-500 text-xs">(incl. verzek.)</span></td>
                      <td className="text-right px-1 sm:px-2 md:px-4 py-1 md:py-2 text-gray-900 dark:text-gray-100 text-xs md:text-sm">
                        {getSymbol()}
                        {Math.floor(bracket.incomeInBracket).toLocaleString('en-US')}
                      </td>
                      <td className="text-right px-1 sm:px-2 md:px-4 py-1 md:py-2 text-red-600 dark:text-red-400 font-medium text-xs md:text-sm">
                        {getSymbol()}
                  ...
                  <tr className="border-b border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800">
                    <td colSpan="3" className="px-1 sm:px-2 md:px-4 py-1 md:py-2 text-gray-900 dark:text-gray-100 font-bold text-xs md:text-sm">
                      {t('tax.subtotalBeforeCredits')}
                    </td>
                    <td className="text-right px-1 sm:px-2 md:px-4 py-1 md:py-2 text-red-600 dark:text-red-400 font-bold text-xs md:text-sm">
                      {getSymbol()}
                  ...
                  <tr className="border-b border-gray-100 dark:border-gray-700">
                    <td colSpan="3" className="px-1 sm:px-2 md:px-4 py-1 md:py-2 text-gray-900 dark:text-gray-100 text-xs md:text-sm">
                      {t('tax.generalTaxCredit')}
                    </td>
                    <td className="text-right px-1 sm:px-2 md:px-4 py-1 md:py-2 text-green-600 dark:text-green-400 font-medium text-xs md:text-sm">
                      -{getSymbol()}
                  ...
                  <tr className="bg-blue-50 dark:bg-blue-900/20 font-bold">
                    <td colSpan="3" className="px-1 sm:px-2 md:px-4 py-1 md:py-2 text-gray-900 dark:text-gray-100 text-xs md:text-sm">{t('tax.totalTax')}</td>
                    <td className="text-right px-1 sm:px-2 md:px-4 py-1 md:py-2 text-blue-600 dark:text-blue-400 text-xs md:text-sm">
                      {getSymbol()}
